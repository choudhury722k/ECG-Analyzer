...
def featureSelection(X,percentage=24):
    ...
    """
    featureRanking = pickle.load(open(r"D:\Important\Project\Medical\ECG Analyzer\Training\Pickles\featureRanking.p",'rb'))     # load the feature ranking / order 
...
if __name__ == "__main__":
    kFoldCrossValidation(file=r"D:\Important\Project\Medical\ECG Analyzer\Training\Pickles\smoteData.p",featurePercent=24)
